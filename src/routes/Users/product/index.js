...
router.put("/products/hidden/:product_id",authorization,checkRole(['seller','admin']), asyncHandle(productController.hiddenProduct))
router.put("/products/show/:product_id",authorization,checkRole(['seller','admin']), asyncHandle(productController.showProduct))
